...
public class SalaController implements Serializable {
    ...
    @EJB
    private com.facade.SalaFacade ejbFacade;
    ...
    public Sala getSelected() {
        if (current == null) {
            current = new Sala();
            current.setSalaPK(new com.modelo.SalaPK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public String create() {
        try {
            current.getSalaPK().setIdSede(current.getSede().getIdSede());
            getFacade().create(current);
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SalaCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SalaUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("SalaDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public static class SalaControllerConverter implements Converter {
        ...
        com.modelo.SalaPK getKey(String value) {
            com.modelo.SalaPK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.modelo.SalaPK();
            key.setIdSala(Integer.parseInt(values[0]));
            key.setIdSede(Integer.parseInt(values[1]));
            return key;
        }

        String getStringKey(com.modelo.SalaPK value) {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Sala) {
                Sala o = (Sala) object;
                return getStringKey(o.getSalaPK());
            } else {
