...
public class ClienteController implements Serializable {
    ...
    public Cliente getSelected() {
        if (current == null) {
            current = new Cliente();
            current.setClientePK(new com.modelo.ClientePK());
            selectedItemIndex = -1;
        }
        return current;
    }
    ...
    public static class ClienteControllerConverter implements Converter {
        ...
        com.modelo.ClientePK getKey(String value) {
            com.modelo.ClientePK key;
            String values[] = value.split(SEPARATOR_ESCAPED);
            key = new com.modelo.ClientePK();
            key.setTipoDocumento(values[0]);
            key.setDocumento(values[1]);
            return key;
        }

        String getStringKey(com.modelo.ClientePK value) {
            StringBuilder sb = new StringBuilder();
            sb.append(value.getTipoDocumento());
            sb.append(SEPARATOR);
            sb.append(value.getDocumento());
            return sb.toString();
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Cliente) {
                ...
                return getStringKey(o.getClientePK());
            } else {
